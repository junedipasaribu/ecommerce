...
export default function Users() {
  ...
  const submitAdd = async (e) => {
    ...
    // VALIDATION
    if (!form.name.trim()) {
      return Swal.fire("Validation Error", "Nama tidak boleh kosong.", "warning");
    }

    if (!form.email.trim()) {
      return Swal.fire("Validation Error", "Email tidak boleh kosong.", "warning");
    }

    if (!form.password.trim()) {
      return Swal.fire("Validation Error", "Password tidak boleh kosong.", "warning");
    }

    if (form.password.length < 6) {
      return Swal.fire("Validation Error", "Password minimal 6 karakter.", "warning");
    }
  ...
  const calculateUserStats = () => {
    ...
    // For now, consider all users as active since we don't have active/inactive status
    // In the future, this could be based on lastLoginAt, isActive field, etc.
            ...
            return (
              <div className="d-flex gap-3 mt-2">
                <small className="text-muted">
                  ...
                  Total: <span className="fw-bold">{userStats?.totalUsers || stats.totalUsers}</span>
                </small>
                <small className="text-muted">
                  <i className="bi bi-person-check me-1"></i>
                  Active: <span className="fw-bold">{userStats?.activeUsers || stats.activeUsers}</span>
                </small>
                <small className="text-muted">
                  <i className="bi bi-shield-check me-1"></i>
                  Admins: <span className="fw-bold">{userStats?.adminUsers || stats.adminUsers}</span>
                </small>
                <small className="text-muted">
                  <i className="bi bi-person me-1"></i>
                  Users: <span className="fw-bold">{stats.regularUsers}</span>
                </small>
              </div>
            );
          })()}
            ...
            <form onSubmit={submitAdd} className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button 
                  ...
                  disabled={!canManage || !form.name || !form.email || !form.password}
                >
