    ...
    const loadDashboardData = async () => {
      try {
        ...
        try {
          ...
          // Fallback to orders, products, categories data
          try {
        ...
        if (mounted) {
          ...
          setDashboardData({
            overview: {
              ...
              totalProducts: { title: "Total Products", value: "0", subtitle: "Product new", trend: "stable", trendValue: "0%" },
              revenueChart: [],
              ordersByStatus: [],
              topProducts: [],
              topCategories: [],
        ...
        <div className="col-12 col-md-4">
          ...
          >
            ...
            <div className="flex-grow-1">
              ...
              <div className="small text-muted">
                {overview.totalProducts?.subtitle || "Product new"}
              </div>
